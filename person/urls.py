...
urlpatterns = [
    ...
    path('registers/<int:pk>', views.registers, name='registers'),
    # Urls Teachers
    ...
    path('export/excel/person', views.export_excel_person,
         name='export_excel_person'),
    path('export/excel/student', views.export_excel_student,
         name='export_excel_student'),
    path('export/excel/teacher', views.export_excel_teacher,
         name='export_excel_teacher'),
    path('export/excel/graduate', views.export_excel_graduate,
         name='export_excel_graduate'),
]
